...
\begin{enumerate}
    ...
    woman. If he had omitted to perform his duty, he would have been criminally liable 
    for manslaughter.
...
\subsubsection{Constitutional Limitations on Criminalizing Conduct: \emph{Lawrence v. Texas}}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        of the crime.
    \end{enumerate}
    % todo: verify -- general culpability has given way to elemental 
    % culpability, including in the MPC, because [...]
\end{enumerate}
...
For specific intent crimes, it doesn't matter whether a mistake of fact is reasonable.
...
\begin{enumerate}
    ...
    resulting harm.
    \item \textbf{Proximate cause answers the question of who is most culpable for the 
    harm.}
    \item \textbf{The MPC does not use the term ``proximate cause.''} Issues related to 
    proximate cause are treated as relating to the actor's culpability. See 
    MPC \S\ 2.03(2)(b) and (3)(b).
\end{enumerate}
