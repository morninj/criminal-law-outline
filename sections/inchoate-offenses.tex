...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        (i.e., incapacitation and specific deterrence).
...
\begin{enumerate}
    \item \textbf{Merger}: you cannot be convicted of both the attempted crime 
    and the completed crime.
    \item Attempt is a \textbf{specific intent crime}. You must have the 
    intent to complete the target offense.
    \item The MPC and common law align on abandonment.
    % TODO double inchoate offenses: why are they problematic? see p. 793 n. 2
    \item Wharton's Rule prevents conspiracy charges for crimes requiring 
    multiple participants. Wharton's rule presumes merger. There is no 
    Wharton's Rule in the MPC because under the MPC, conspiracy always merges 
...
\begin{enumerate}
    ...
    % TODO solicitation: common law vs mpc
    % TODO: define pinkerton liability
